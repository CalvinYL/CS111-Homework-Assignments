 ...
 * 
 * printBirthdays method completed by:
 */
...
public class BirthdayCalculator {
    ...
    public static void printBirthdays(Person[] people, int year) {
        ...
        for (int i = 0; i < people.length; i++) {
            System.out.println(people[i].getName() + ": " + people[i].getBirthdayIn(year) 
                + " (" + people[i].getAgeOn(people[i].getBirthdayIn(year)) + " years old)");
